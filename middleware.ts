...
const protectedRoutes = ['/dashboard', '/translate', '/logs', '/about', '/account', '/templates', '/onboarding'];
...
export const config = {
  matcher: ['/dashboard/:path*', '/translate/:path*', '/logs/:path*', '/about/:path*', '/account/:path*', '/templates/:path*', '/onboarding/:path*']
};
